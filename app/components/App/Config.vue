...
const { layoutState, layoutConfig, setPrimary, setSurface, setPreset, setMenuMode, setLayoutTheme, onConfigSidebarToggle, toggleDarkMode, isDarkTheme } = useLayout();
...
const layoutTheme = ref(layoutConfig.layoutTheme);
          ...
          <div class="flex flex-col gap-2">
            ...
            <div class="flex flex-col gap-4">
              <div class="flex items-center gap-2">
                <RadioButton name="layoutTheme" value="colorScheme" v-model="layoutTheme" inputId="layoutTheme-colorscheme" @change="setLayoutTheme('colorScheme')"></RadioButton>
                <label for="layoutTheme-colorscheme">Color Scheme</label>
              </div>
              <div class="flex items-center gap-2">
                <RadioButton name="layoutTheme" value="primaryColor" v-model="layoutTheme" inputId="layoutTheme-primarycolor" @change="setLayoutTheme('primaryColor')" :disabled="isDarkTheme"></RadioButton>
                <label for="layoutTheme-primarycolor">Primary Color (Light Only)</label>
              </div>
            </div>
          </div>
        </div>
